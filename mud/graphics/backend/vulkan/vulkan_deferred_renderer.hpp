#ifndef VULKAN_DEFERRED_RENDERER_HPP
#define VULKAN_DEFERRED_RENDERER_HPP
...
#include "graphics/interface/deferred_renderer_base.hpp"
...
namespace mud::graphics_backend::vk
{
	...
	class VulkanDeferredRenderer : public mud::DeferredRendererBase
	{
	public:

		VulkanDeferredRenderer(RenderPassOptions renderPassOptions);
