#ifndef DEFERRED_RENDERER_BASE_HPP
#define DEFERRED_RENDERER_BASE_HPP
...
namespace mud
{
	...
	public:
		...
		DeferredRendererBase(RenderPassOptions renderPassOptions);

		virtual ~DeferredRendererBase();
